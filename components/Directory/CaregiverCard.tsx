      ...
      <div className="relative h-48 bg-gradient-to-br from-gray-200 to-gray-300 overflow-hidden">
        ...
        <div className="absolute bottom-3 right-3">
          <span className="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white px-3 py-2 rounded-xl text-xs font-bold shadow-lg backdrop-blur-sm">
            {caregiver.yearsInBusiness} {caregiver.yearsInBusiness === 1 ? "yr" : "yrs"} exp.
          </span>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center gap-1.5 text-sm text-gray-600">
            ...
            <span className="font-medium">{caregiver.city}, {caregiver.state}</span>
          </div>
        </div>
        ...
        {caregiver.averageRating != null && caregiver.reviewCount && caregiver.reviewCount > 0 && (
          <div className="flex items-center gap-2 mb-4 pb-4 border-b border-gray-100">
            <div className="flex items-center gap-1.5 bg-yellow-50 px-3 py-1.5 rounded-lg border border-yellow-200">
              ...
              <span className="font-bold text-gray-900">{caregiver.averageRating.toFixed(1)}</span>
            </div>
        ...
        {caregiver.careTypesOffered && caregiver.careTypesOffered.length > 0 && (
          <div className="mb-4">
            <p className="text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Care Specialties</p>
            <div className="flex flex-wrap gap-2">
              {caregiver.careTypesOffered.slice(0, 3).map((type) => (
                <span
                  key={type}
                  className="inline-flex items-center gap-1 px-3 py-1.5 bg-gradient-to-r from-purple-50 to-purple-100 text-purple-700 text-xs font-semibold rounded-lg border border-purple-200"
                >
        ...
        {caregiver.certifications && caregiver.certifications.length > 0 && (
          <div className="mb-4">
            <p className="text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Certifications</p>
            <div className="flex flex-wrap gap-2">
              {caregiver.certifications.slice(0, 2).map((cert) => (
                <span
                  key={cert}
                  className="inline-flex items-center gap-1 px-3 py-1.5 bg-gradient-to-r from-emerald-50 to-emerald-100 text-emerald-700 text-xs font-semibold rounded-lg border border-emerald-200"
                >
                  <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
