        ...
        <div className={`transition-all duration-300 ease-in-out ${
          ...
          <div className="max-w-7xl mx-auto px-4 py-2.5">
            <div className="relative flex items-center gap-3">
              ...
              {/* Search bar — absolutely centered on desktop, same width as provider page */}
              <div className="flex-1 lg:flex-none lg:absolute lg:left-1/2 lg:-translate-x-1/2 min-w-0 lg:min-w-[400px] lg:max-w-[480px]">
                <button
                  type="button"
                  onClick={() => setSearchExpanded(true)}
                  className="w-full flex items-center gap-1 bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer pl-1.5 pr-1.5 py-1.5"
                >
              ...
              {/* Filters pill — positioned after search bar */}
              <button
