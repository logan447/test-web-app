...
import PendingVerificationBanner from "@/components/Provider/PendingVerificationBanner";
...
function DashboardPageContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <MainNav />
      <OnboardingManager autoOpen={false} />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <Link
              href={isFamily ? "/dashboard/care-profile" : "/dashboard/provider-profile"}
            ...
            >
              ...
              {isFamily ? "Edit Care Profile" : "Edit Provider Profile"}
            </Link>
          </div>
        </div>
        ...
        {/* Pending Verification Banner (for claimed provider profiles) */}
