                  ...
                  {unlockedProfileIds.has(profile.id) ? (
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center text-sm">
                        ...
                        <a href={`mailto:${profile.user.email}`} className="text-primary-600 hover:text-primary-700">
                          {profile.user.email}
                        </a>
                      </div>
                      {profile.user.phone && (
                        <div className="flex items-center text-sm">
                          ...
                          <a href={`tel:${profile.user.phone}`} className="text-primary-600 hover:text-primary-700">
                            {profile.user.phone}
                          </a>
                        </div>
                      )}
                    ...
                    <div className="space-y-2">
                      {(() => {
                        const masked = maskContactInfo(profile.user);
                        return (
                          <>
                            ...
                            <button
                              onClick={() => handleUnlockContact(profile.id)}
                              className="mt-3 w-full flex items-center justify-center gap-2 px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700 font-medium transition-colors"
                            >
                              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
