...
export async function seedDemo(prisma: PrismaClient) {
  ...
  const unclaimedData = [
    {
      ...
      state: 'CA',
      zip: '95110',
      desc: 'A welcoming community for seniors in the heart of San Jose.',
    ...
    },
    {
      ...
      state: 'CA',
      zip: '93701',
      desc: 'Affordable senior living in the Central Valley.',
    ...
    },
    {
      ...
      state: 'CA',
      zip: '95814',
      desc: 'Full-service nursing care and rehabilitation in the capital.',
    ...
    },
    {
      ...
      state: 'CA',
      zip: '94301',
      desc: 'Specialized memory care with beautiful garden setting.',
    ...
    },
    {
      ...
      state: 'CA',
      zip: '90401',
      desc: 'Home care services along the central coast.',
  ...
  for (let i = 0; i < unclaimedData.length; i++) {
    ...
    await prisma.provider.create({
      data: {
        ...
        photos: FACILITY_PHOTOS.slice(0, 3),
  ...
  const reviewContent = [
    { rating: 5, title: 'Outstanding care and compassion', content: 'The staff here is incredible. My mother has been so happy since moving in. They treat every resident like family and the activities keep her engaged.', relationship: 'Daughter of resident', lengthOfStay: '1 year' },
    { rating: 5, title: 'Could not ask for better', content: 'From the moment we walked in we knew this was the right place. Clean, warm, welcoming. The care team is responsive and truly cares about the residents.', relationship: 'Son of resident', lengthOfStay: '6 months' },
    { rating: 5, title: 'Exceptional memory care program', content: 'My father has Alzheimers and the specialized memory care program here has been life-changing. The staff is trained and patient. He seems calmer and happier.', relationship: 'Daughter of resident', lengthOfStay: '8 months' },
    { rating: 4, title: 'Very good overall experience', content: 'Great facility with caring staff. The food could be more varied but otherwise we are very happy with the care my mother receives here.', relationship: 'Son of resident', lengthOfStay: '2 years' },
    { rating: 4, title: 'Good care, nice community', content: 'My parents enjoy the social activities and the staff is attentive. The grounds are beautiful. Only minor issue is scheduling for physical therapy can be slow.', relationship: 'Daughter of residents', lengthOfStay: '1 year' },
    { rating: 4, title: 'Reliable and professional', content: 'They have been taking care of my father for over a year and we are generally very satisfied. Communication could be slightly better during shift changes.', relationship: 'Son of resident', lengthOfStay: '14 months' },
    { rating: 4, title: 'Would recommend to others', content: 'Clean rooms, friendly staff, and good food. My mother enjoys the garden area. We feel confident she is well cared for here.', relationship: 'Daughter of resident', lengthOfStay: '9 months' },
    { rating: 3, title: 'Decent but has room to improve', content: 'The care is adequate and the facility is clean. Some staff turnover has been an issue. The activities program could be more robust for more active seniors.', relationship: 'Wife of resident', lengthOfStay: '6 months' },
    { rating: 3, title: 'Mixed experience', content: 'The caregivers are kind but the administrative side can be frustrating. Billing issues took weeks to resolve. The actual care quality is good though.', relationship: 'Son of resident', lengthOfStay: '4 months' },
    { rating: 3, title: 'Average facility, good staff', content: 'The building is older and could use some updates but the staff makes up for it with their genuine care and attention to residents.', relationship: 'Daughter of resident', lengthOfStay: '3 months' },
    { rating: 2, title: 'Needs improvement', content: 'We had some concerns about response times during off-hours. The daytime staff is much better. We are monitoring the situation.', relationship: 'Son of resident', lengthOfStay: '2 months' },
    { rating: 5, title: 'Best decision we ever made', content: 'Moving my mom here was the best decision. She has made friends, stays active, and the medical oversight gives us peace of mind.', relationship: 'Daughter of resident', lengthOfStay: '18 months' },
    { rating: 4, title: 'Professional and caring team', content: 'The nursing staff is top-notch. They caught a health issue early that we missed. Very grateful for their attentiveness.', relationship: 'Husband of resident', lengthOfStay: '10 months' },
    { rating: 5, title: 'Wonderful hospice support', content: 'During the most difficult time of our lives, this team provided incredible support for both my father and our family. Truly compassionate care.', relationship: 'Daughter of patient', lengthOfStay: '3 months' },
    { rating: 4, title: 'Great value for the price', content: 'Compared to other options we looked at, this facility offers excellent care at a fair price. The amenities are good and the location is convenient.', relationship: 'Son of resident', lengthOfStay: '7 months' },
    { rating: 5, title: 'Highly recommend this caregiver', content: 'Professional, punctual, and genuinely kind. My father looks forward to their visits. They handle his Parkinsons care with expertise and patience.', relationship: 'Daughter of client', lengthOfStay: '5 months' },
    { rating: 4, title: 'Skilled and reliable', content: 'Great in-home caregiver. Very skilled with medication management and mobility assistance. Would recommend for anyone needing home care.', relationship: 'Son of client', lengthOfStay: '4 months' },
    { rating: 5, title: 'Life-changing home care', content: 'Having a caregiver come to our home has allowed my mother to age in place safely. The agency matched us with the perfect person.', relationship: 'Daughter of client', lengthOfStay: '1 year' },
    { rating: 3, title: 'Good care, scheduling issues', content: 'The caregivers themselves are wonderful but we have had scheduling changes that were inconvenient. The care quality is high when they are here.', relationship: 'Wife of client', lengthOfStay: '3 months' },
    { rating: 5, title: 'Above and beyond', content: 'This facility goes above and beyond. They organized a birthday party for my dad and the chef made his favorite meal. Small touches that mean everything.', relationship: 'Son of resident', lengthOfStay: '11 months' },
    { rating: 4, title: 'Clean and well-maintained', content: 'The facility is always clean and well-maintained. Staff is friendly. My only wish is for more outdoor activities during nice weather.', relationship: 'Daughter of resident', lengthOfStay: '8 months' },
    { rating: 2, title: 'Communication could be better', content: 'The care is acceptable but communication with family members needs significant improvement. We often feel out of the loop about our loved one.', relationship: 'Son of resident', lengthOfStay: '5 months' },
    { rating: 5, title: 'Exceeded all expectations', content: 'From the tour to move-in day and beyond, everything has been smooth. The transition team made it easy and my mother settled in quickly.', relationship: 'Daughter of resident', lengthOfStay: '6 months' },
    { rating: 4, title: 'Solid memory care program', content: 'The memory care unit is secure and the staff understands dementia. Activities are appropriate and engaging. My husband seems less agitated here.', relationship: 'Wife of resident', lengthOfStay: '9 months' },
    { rating: 5, title: 'Amazing rehabilitation services', content: 'After hip surgery, the rehab team here got my mother walking again in just 3 weeks. Physical therapy is top-tier.', relationship: 'Son of patient', lengthOfStay: '1 month' },
    { rating: 4, title: 'Great companion caregiver', content: 'Our caregiver has become like family. They play cards, go for walks, and genuinely enjoy spending time together. Dad loves the company.', relationship: 'Daughter of client', lengthOfStay: '6 months' },
    { rating: 1, title: 'Disappointing experience', content: 'We expected more based on the tour. Staffing seemed thin on weekends and our requests were sometimes forgotten. We have since moved to another facility.', relationship: 'Son of former resident', lengthOfStay: '2 months' },
    { rating: 5, title: 'Peaceful and dignified', content: 'The end-of-life care was handled with such grace and dignity. Our family was supported every step of the way. Cannot thank them enough.', relationship: 'Daughter of patient', lengthOfStay: '2 months' },
    { rating: 4, title: 'Responsive to feedback', content: 'We raised some concerns early on and they addressed them quickly. Appreciate the open communication and willingness to improve.', relationship: 'Son of resident', lengthOfStay: '4 months' },
    { rating: 5, title: 'Five stars from our entire family', content: 'Every family member who has visited has been impressed. The warmth, professionalism, and attention to detail are evident throughout.', relationship: 'Granddaughter of resident', lengthOfStay: '1 year' },
    { rating: 3, title: 'Adequate but pricey', content: 'The care is acceptable but for the price we expected more amenities and activities. The staff is friendly but turnover is noticeable.', relationship: 'Daughter of resident', lengthOfStay: '3 months' },
    { rating: 4, title: 'Good nursing care', content: 'The nursing staff is experienced and attentive. They manage my fathers complex medication schedule without issues. Facility is a bit dated but clean.', relationship: 'Son of resident', lengthOfStay: '7 months' },
    { rating: 5, title: 'Like a second family', content: 'The caregivers here have become like a second family to my mother. She lights up when they arrive. Best in-home care agency we could find.', relationship: 'Daughter of client', lengthOfStay: '14 months' },
    { rating: 4, title: 'Excellent therapists', content: 'The physical and occupational therapists are outstanding. My mother has regained significant mobility. The rest of the care is also very good.', relationship: 'Son of patient', lengthOfStay: '6 weeks' },
    { rating: 5, title: 'True compassion in action', content: 'Every interaction shows genuine compassion. From the front desk to the nursing staff to the kitchen team. This is how senior care should be.', relationship: 'Daughter of resident', lengthOfStay: '2 years' },
  ];
  ...
  console.log(`    - ${unclaimedData.length} unclaimed providers (for claiming flow)`);
  console.log(`    - ${reviewIndex} reviews across providers`);
